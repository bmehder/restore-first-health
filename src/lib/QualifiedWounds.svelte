...
<div class="container">
	<div class="wound-qualifications">
		<!-- 1 -->
		<div></div>

		<!-- 2 -->
		<div class="item">
			Is larger than 2cm x 2cm
		</div>
...
<style>
  .wound-qualifications {
	...
	@container (min-width: 24rem) {
		...
		.wound-qualifications .right {
			justify-self: start;
			rotate: 45deg;
		}
		
		.wound-qualifications .bottom {
			rotate: 0deg;
		}
	}
</style>