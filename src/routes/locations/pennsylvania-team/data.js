export default [
	{
		src: '/pennsylvania/chloe-ruschmeyer.jpg',
		name: 'Chloe Ruschmeyer',
		job: 'Nurse Practitioner',
		description: `<p>Chloe Ruschmeyer is a Board-Certified Family Nurse Practitioner. She obtained a Bachelor's degree from Kean University and a Master's degree from Drexel University where she graduated with honors. She has over 15 years of experience in nursing which includes post anesthesia recovery, trauma response, step-down cardiac care, urgent care, women's health and medical aesthetics.</p>

    <p>Her foundation in wound care experience and expertise has developed throughout her nursing career at the bedside and in a wound care clinic. She implemented wound prevention and closure while working with a hospital-based quality assurance committee for several years.</p>
